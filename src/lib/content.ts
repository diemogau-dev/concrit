 ...
 *
 * El copy vive acá y no dentro de los componentes: así se puede revisar el
 * texto sin leer JSX, y el mismo banco de FAQ alimenta el acordeón visible
 * y el JSON-LD de FAQPage sin riesgo de que se desincronicen.
 */
...
export const faqs: Faq[] = [
  ...
  },
  {
    ...
    a: "Las formas habituales de plaza. Para vivienda trabajamos en cuotas a través de aliados que financian al cliente final: banco, financiera o loteadora, según el caso. Todas las condiciones quedan escritas en el presupuesto antes de que pongas un guaraní.",
  },
  {
    q: "¿Ofrecen financiamiento para vivienda?",
    a: "Sí. Las casas se pagan en cuotas a través de aliados que financian al cliente final. Es vivienda de material noble pensada para que sea accesible: concreto macizo al alcance de una familia trabajadora.",
  },
  {
  ...
  {
    q: "¿Hacen proyectos a medida o solo modelos de catálogo?",
  ...
  },
  {
    ...
    a: "Los pilares son metálicos y las placas son de concreto macizo. El pilar arma la retícula que sostiene todo y la placa cierra el muro: encastran entre sí y se traban con tornillos pasantes. Esa combinación es la que permite montar rápido y anexar módulos después sin romper nada.",
  },
  {
  ...
  },
  {
    ...
    a: "Sí, y es lo que más recomendamos. Estamos sobre la Ruta 9 en Villa Hayes, a la vista y fácil de encontrar. Venís, mirás cómo se produce y tocás el producto antes de decidir. Abrimos de lunes a sábado de 7 a 17.",
  },
  {
