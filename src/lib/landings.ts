 ...
 * mismo WhatsApp que el resto del sitio. El copy arranca siempre por el
 * problema del que busca, no por el producto: quien googlea "obrador
 * prefabricado" ya sabe qué es un obrador, lo que quiere saber es si
 * resuelve lo que le está pasando en la obra.
 *
 * Regla del contenido: no se inventan medidas, precios ni plazos. Cuando
 * el dato depende del caso, la respuesta lo dice y manda a la conversación.
 */
...
const casas: Landing = {
  ...
  metaDescription:
    "Casas prefabricadas de concreto macizo de 1, 2 y 3 habitaciones en Paraguay. Se entregan terminadas, con precio cerrado, montaje incluido y pago en cuotas. Fábrica sobre la Ruta 9, Villa Hayes.",
  keywords: [
  ...
  blocks: [
    {
      ...
      paragraphs: [
        ...
        "Las nuestras son de placas de concreto macizo montadas sobre pilares metálicos. Es el mismo material noble de una obra tradicional, con la diferencia de que se fabrica en planta con calidad controlada y se monta en tu terreno. No lo carcome la termita, no lo hincha la humedad, no lo quema el fuego y no se lo lleva nadie.",
    ...
    },
    {
      ...
      paragraphs: [
        "Las casas se pagan en cuotas a través de aliados que financian al cliente final: banco, financiera o loteadora, según el caso. Es vivienda de material noble pensada para que sea accesible, no para que quede lindo en el folleto.",
        "El precio de la casa queda cerrado en el presupuesto, con el alcance escrito y la fecha de entrega comprometida, antes de que pongas un guaraní. Lo que firmás es lo que pagás.",
        "Si estás comprando terreno en un loteamiento, contanos cuál: trabajamos con desarrolladoras de la zona de Villa Hayes y Chaco’i, y en varios casos el terreno y la casa se resuelven en el mismo plan.",
      ],
    },
    {
      kind: "steps",
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Sí, a todo el país. Estar sobre la Ruta 9 nos deja el flete más corto hacia el interior y el Chaco. Pasanos la ubicación y te cerramos el costo de entrega junto con el presupuesto, no después.",
    },
    {
      q: "¿No sale más caro que construir con ladrillo?",
      a: "Por metro cuadrado la diferencia es mucho menor de lo que la gente cree. Y cuando sumás los meses de obra, la mano de obra, el material que se desperdicia y el presupuesto que se estira, el prefabricado termina saliendo igual o menos. Con una diferencia: sabés cuánto vas a pagar antes de empezar.",
    },
  ],
};
...
const ganado: Landing = {
  ...
  metaDescription:
    "Comederos, bebederos y tanques australianos de concreto macizo para ganado en Paraguay. Aguantan el sol, el agua y el empuje del animal. Fábrica sobre la Ruta 9, Villa Hayes, con entrega y montaje propios al Chaco y todo el país.",
  keywords: [
  ...
  heroAlt:
    "Bebedero de concreto macizo CONCRIT para ganado instalado en una estancia del Chaco paraguayo",
  waHref: wa.ganado,
  ...
  blocks: [
    ...
    },
    {
      ...
      paragraphs: [
        "La fábrica está sobre la Ruta 9, en Villa Hayes: la puerta del Chaco y el corredor por el que pasa todo lo que entra y sale del norte. No es un dato de folleto, es flete más corto y más barato para el productor y para la cooperativa.",
...
const obradores: Landing = {
  ...
  metaDescription:
    "Obradores prefabricados, vestuarios, depósitos y galpones de concreto macizo para obra en Paraguay. Venta y alquiler mensual, montaje en semanas con precio cerrado y fecha comprometida. Fábrica en Villa Hayes, Ruta 9.",
  keywords: [
  ...
  heroImg: "/assets/obra-blanco.jpg",
  heroAlt:
    "Obrador prefabricado de hormigón CONCRIT montado en una obra industrial en Paraguay",
  waHref: wa.obradores,
